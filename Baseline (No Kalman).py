...
init_theta = math.atan2(initial_rot[0], initial_rot[1]) - (math.pi / 2)
...
while robot.step(timestep) != -1:
    ...
    # --- STEP 5: DISPLAY (SWITCHED COLORS) ---
    ...
    if not saved and robot.getTime() >= 600:
        ...
        display.imageSave(ref, "no_kalman_map.png")
        saved = True
